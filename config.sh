...
ADDITIONAL_PACKAGES="locales,dirmngr,git,ca-certificates,apt-transport-https,nano,openssl,openssh-server,curl,xz-utils,wpasupplicant,gcc,g++,make,xorg,openbox"
